...
list_under<-c(list_under, title)
  ...
  jpeg("E:\\Research\\All ML works\\Graph Theory approach\\Pseudovibentero\\conf_mat\\aac_U.jpeg",width= 17, height=12, units="cm", res=300)
 # file_n<-paste0("E:\\Research\\All ML works\\Extracted Feature_revised\\CD-HIT Resistance Genes\\Merged_AAC\\combin_final\\GT\\subset3\\Merged_aac_with non_AR_S_5", ".csv")
 # file_other<-paste0("E:\\Research\\All ML works\\Each AMR gene\\split\\Sequence\\Test1\\joined\\separate\\Filtered\\Pseudomonas Vibrio Enterobacter\\aac\\merged_aac\\aac_selected_feature_under",".csv")
  file_other<-paste0("E:\\Research\\All ML works\\Graph Theory approach\\Pseudovibentero\\aac_merged_feature_under6",".csv")
  ...
  file_other<-paste0("E:\\Research\\All ML works\\Graph Theory approach\\Pseudovibentero\\bl_merged_feature_under7",".csv")
  jpeg("E:\\Research\\All ML works\\Graph Theory approach\\Pseudovibentero\\conf_mat\\bl_U.jpeg",width= 17, height=12, units="cm", res=300)
  ...
  file_other<-paste0("E:\\Research\\All ML works\\Graph Theory approach\\Pseudovibentero\\dfr_merged_feature_under2",".csv")
  jpeg("E:\\Research\\All ML works\\Graph Theory approach\\Pseudovibentero\\conf_mat\\dfr_U.jpeg",width= 17, height=12, units="cm", res=300)
  data <- read.csv(file_n, header = TRUE)
  data_other <- read.csv(file_other, header = TRUE)
